...
public class DontThinkTheyreDead extends SingleUseCard
{
	...
	{
		super(PossibleTarget.Pick, "I Don't Think They're Dead", "Play this card to make target opponent roll two dice. If either die result is 3 or lower," +
	...
	public int behavior(int num) 
	{
		...
		String message = "Player " + (getTargetPlayer().getNumber() + 1) + ", you have rolled two dice to protect your zombies. You first roll: " + roll1 +
				". Your second roll: " + roll2 + ".";
