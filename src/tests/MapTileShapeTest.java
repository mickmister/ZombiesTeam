...
public class MapTileShapeTest
{
	...
	{
		MapTile tile = new MapTile(Shape.empty);
	...
	{
		MapTile tile = new MapTile(Shape.L);
	...
	{
		MapTile tile = new MapTile(Shape.T);
	...
	{
		MapTile tile = new MapTile(Shape.straight);
	...
	public void testSpecialTile()
	{
		...
		MapTile tile = new MapTile(Shape.special, SpecialNames.ArmySurplus, "4 0 0 1 1 1 0 0 0 5 6 7");
		...
		tile = new MapTile(Shape.special, SpecialNames.ArmySurplus, "0 1 2 0 1 2 0 1 2 7 8 9");
